...
make_barplot<-function(x, 
  ...
  ggp<- ggplot(df)+
    ...
    labs(subtitle=selected_metabolite,
         title=subtitle,
...
#interest
dir.create(paste0(path,"interest\\"))
unlink(paste0(paste0(path,"interest\\"),
              list.files(paste0(path,"interest\\"))))
genes_interest <-c("COL6A1","COL6A2","PFKL","SOD1")
df_ana<-FindUniprotGenename(genes_interest)
df_ana
